...
public final class Constants {
    ...
    public static final long FILE_WAIT_TIMEOUT_SECONDS = 30;
    public static final long FILE_STABLE_DURATION_MS = 2000;
    public static final long FILE_POLL_INTERVAL_MS = 500;
    public static final String DEFAULT_DOWNLOAD_DIR = Paths.get(PROJECT_ROOT_PATH, "target", "downloads").toString();
    ...
    //Buggy Cars
    public static final String BUGGY_CARS_BASE_URL = "https://buggy.justtestit.org";

    //Buggy Cars URLs
    public static final String BUGGY_CARS_REGISTER_URL = BUGGY_CARS_BASE_URL + "/register";
    public static final String BUGGY_CARS_LOGIN_URL = BUGGY_CARS_BASE_URL + "/login";
    public static final String BUGGY_CARS_HOME_URL = BUGGY_CARS_BASE_URL + "/home";
    public static final String BUGGY_CARS_RANKING_URL = BUGGY_CARS_BASE_URL + "/rankings";
    public static final String BUGGY_CARS_SEARCH_URL = BUGGY_CARS_BASE_URL + "/search";
    public static final String BUGGY_CARS_MY_RECORD_URL = BUGGY_CARS_BASE_URL + "/my-records";
    public static final String BUGGY_CARS_LOGOUT_URL = BUGGY_CARS_BASE_URL + "/logout";
