...
public final class TextboxLocators {
    ...
    public static final By OUTPUT_CURRENT_ADDRESS = By.cssSelector("#output #currentAddress");
    public static final By OUTPUT_PERMANENT_ADDRESS = By.cssSelector("#output #permanentAddress");
