package page.demoqa.elements.webtables;

import core.BasePage;
import locator.demoqa.elements.WebTablesLocators;
...
import static common.Constants.DEMOQA_WED_TABLES_URL;
...
public class WebTablesPage extends BasePage {
    ...
    private String getCellText(WebElement row, WebTableColumn column) {
        List<WebElement> cells = row.findElements(WebTablesLocators.CELL);
    ...
    public Optional<WebElement> findRecordByEmail(String email) {
        ...
        Optional<WebElement> result = getAllDataRows().stream()
                .filter(row -> email.equals(getCellText(row, WebTableColumn.EMAIL)))
                .findFirst();
    ...
    public WebTablesPage clickColumnHeader(WebTableColumn column) {
    ...
    public SortDirection getColumnSortDirection(WebTableColumn column) {
        WebElement headerCell = getHeaderCell(column);
    ...
    private WebElement getHeaderCell(WebTableColumn column) {
    ...
    private boolean isRealDataRow(WebElement row) {
        ...
        if (cells.size() <= WebTableColumn.EMAIL.index) {
